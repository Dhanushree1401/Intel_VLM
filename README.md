The project is an AI-powered image search engine that was constructed with the CLIP model from OpenAI and FastAPI. The live link is as follows:https://dhanushree1401.github.io/Intel_VLM/
